...
M.smart_open = function(arg)
    ...
    if arg == "visualsel" then
        ...
        local l = vim.api.nvim_buf_get_lines(vim.api.nvim_get_current_buf(),
                                             csrow, csrow + 1, true)
        arg = l[1]
    ...
    io.write(":-:end:-:")
    io.close(file)
    os.execute(os.getenv("HOME") .. "/.config/nvim/lua/user/smart_vi_open.py")
...
M.ansi_codes = {
    ...
    _dark_grey = "[0;97m",
    _white = "[0;98m",
    red = function(self, string) return self._red .. string .. self._clear end,
    ...
    blue = function(self, string) return self._blue .. string .. self._clear end,
    magent = function(self, string)
        return self._magenta .. string .. self._clear
    end,
    cyan = function(self, string) return self._cyan .. string .. self._clear end,
    grey = function(self, string) return self._grey .. string .. self._clear end,
